...
```bash
npm install @edybara-editor/flat-list
```
...
import { edybaraFlatOrderedListNodes, edybaraFlatBulletListNodes, edybaraFlatListItemNodes, edybaraFlatListPlugins } from '@edybara-editor/flat-list';
